...
const ListNav = ({ idList, textNav , iconNav ,functionButton , widthList }) => {
    ...
    const widthListNav = `${widthList}  p-2 m-2  hover:bg-green-900 rounded-[10px] cursor-pointer `;

    return (
        <>
            <li data-cursor-exclusion className={widthListNav} onClick={functionButton}>
