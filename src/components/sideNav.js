    ...
    return (
        <>
            <div className='flex items-center justify-start w-[200px] h-[100vh]'>
                <div className='m-2 h-[95%] w-max bg-green-700 rounded-[15px] flex flex-col justify-between items-center'>
                    <ul className='list-none'>
                        {/* listt nav */}
                        <li  id='list5' className=' p-2 m-2 flex items-center justify-end rounded-[10px]'>
                            <div  data-cursor-exclusion  onClick={SmallNav} className='flex items-center justify-center  hover:bg-green-900 w-[28px] h-[28px] bg-white rounded-[10px]'>
