    ...
    return (
      <div id='regis' className=' bg-green-800 w-[400px] h-[60px] flex flex-col items-center rounded-b-[20px] rounded-t-[50px]  ' >
        <div style={titleGap}  className=' p-5 gap-[10px] flex flex-col items-center mb-[20px]' >
            <h2 className='text-2xl font-bold text-white cursor-pointer ' onClick={ titleAction } data-cursor-size='80px' >Sign Up!</h2>
        ...
        <form  id='formRegis' style={ formAction }  className=' flex flex-col gap-[15px] items-center opacity-0'  >
          ...
          <button data-cursor-size='80px' type='submit' className=' w-[250px] px-10 py-3 bg-white text-green-700 font-bold rounded-[5px]  hover:bg-yellow-300 hover:text-white 'onClick={ signUp }  >Sign Up</button>
      </form>
    </div>
    )
  }
