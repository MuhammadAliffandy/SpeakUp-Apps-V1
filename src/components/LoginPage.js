...
const LoginPage = () => {
    ...
    return(
      <section className=' bg-black h-[100vh] flex items-center justify-center overflow-hidden '>
        <div className='h-[500px]'>
          <div id='login' className=' w-[400px] h-[500px] bg-white flex flex-col   rounded-[20px] z-2 relative' >
              ...
              <form style={{ visibility : vislogin }} className=' flex flex-col gap-[15px] items-center mt-[70px] '>
                  ...
                  <button type='submit'  className='w-[250px] px-10 py-3  text-white bg-green-300 rounded-[5px]  hover:bg-green-900 hover:shadow-xl hover:shadow-gray-500  ' onClick={ signIn }  >Masuk</button>
              </form>
          </div>
          <div id='warp' className='z-10 relative h-max top-[-12%] flex flex-col  justify-end items-center'>
            <h2 id='signin' onClick={ signInButton } className=' cursor-pointer text-3xl text-green-600 font-bold m-10 hidden opacity-0'>Sign In</h2>
              <RegisPage 
