...
const SpeakArea = () => {
    ...
    useEffect(()=>{
        ...
        allSpeak.map((data)=>{
            likeCondition(data.id, `like${data.id}` ,sessionPersonId);
        })
    });
        ...
        <section className='flex items-center justify-center h-[100vh] ' >
            ...
            <div  className='w-[900px] h-[90vh] flex flex-col items-center justify-center'>
                ...
                <div className='flex gap-[8px] '>
                    <input id='searchSpeak' onChange={customSearch}   className=' p-2 w-[690px] rounded-[12px] bg-[#303030] placeholder-white text-[12px] focus:text-white' placeholder='Cari speak...' type='text'></input>
                                ...
                                <CardSpeak
                                    ...
                                    allComm={
                                        ...
                                        // tanggal comentar
                                            ...
                                            const tanggalKomen = data.createdAt ; 
                                            const displayTanggalKomen = moment(tanggalKomen).format('DD MMMM YYYY, HH:mm');
                                            ...
                                            return(
                                                <CommentWrap
                                                    ...
                                                    commentDate={displayTanggalKomen}
                                                />
                                            )
                                        })
                                    }
